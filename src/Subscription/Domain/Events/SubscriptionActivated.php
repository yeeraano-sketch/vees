...
final class SubscriptionActivated extends AbstractDomainEvent
{
    ...
    public function entityType(): string { return 'Subscription'; }
    public function producer(): string { return 'SubscriptionModule'; }
    public function payload(): array { return ['subscriptionId' => $this->entityId()]; }
}
